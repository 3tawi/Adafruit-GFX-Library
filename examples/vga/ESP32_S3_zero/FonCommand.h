...
String tmz_str = "GMT +01:00";
int rta = 0, Tz = 1, Tdz = 0;
int sp0 = 10, sp1 = 14, sp2 = 7, sp3 = 210;
int sp4 = 50, sp5 = 160, sp6 = 12, sp7 = 12;
int CCi = 0, MCi = 9, Cis = 0, Cia = 0;
float Temp, Humi;
String textip;
...
class FonCommand {
  ...
  public:
    ...
    void Setup() {
      ...
      dht.setup(2, EspDHT::DHT22);    // data pin 2  DHT22
      // dht.setup(2, EspDHT::DHT11); // data pin 2  DHT11
  ...
  void readAudio() {
    ...
    neopixelWrite(21,bValues[14],bValues[3],bValues[7]);
  }
